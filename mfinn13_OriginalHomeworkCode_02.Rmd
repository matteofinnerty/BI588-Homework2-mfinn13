...
**Starting Notes**
- We are dealing with a poisson distribution
- We are dealing with a discrete random variable
- The mean is equal to 15.
- Because this is a poisson distribution, the variance is equal to 15 as well. 
- The SD is equal to sq. root (15)
- The PMF for poisson distributions is pr(X=x) = ((mean^x)(e^-mean))/(x factorial). This has a function dpois().
- The cumulative distribution function (the probability of observing up to and including a specific number of events in the given interval) has a function ppois(). It takes two arguments (the value at which to evaluate the CDF and the mean of the distribution) 
